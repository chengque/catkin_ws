...
(defsystem "mavros-srv"
  :depends-on (:roslisp-msg-protocol :roslisp-utils :mavros-msg
)
  :components ((:file "_package")
    ...
    (:file "WaypointGOTO" :depends-on ("_package_WaypointGOTO"))
    (:file "_package_WaypointGOTO" :depends-on ("_package"))
