...
(cl:defmethod cl:initialize-instance :after ((m <Control_Refs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control_Refs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<Control_Refs> is deprecated: use mavros-msg:Control_Refs instead.")))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Control_Refs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:theta-val is deprecated.  Use mavros-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <Control_Refs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:phi-val is deprecated.  Use mavros-msg:phi instead.")
  (phi m))

(cl:ensure-generic-function 'psi-val :lambda-list '(m))
(cl:defmethod psi-val ((m <Control_Refs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:psi-val is deprecated.  Use mavros-msg:psi instead.")
  (psi m))

(cl:ensure-generic-function 'thrust-val :lambda-list '(m))
(cl:defmethod thrust-val ((m <Control_Refs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:thrust-val is deprecated.  Use mavros-msg:thrust instead.")
  (thrust m))
