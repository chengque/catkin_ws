...
if("FALSE" STREQUAL "TRUE")
  ...
  set(mavros_INSTALL_PREFIX /home/chengque/catkin_ws/pixhawk)
...
if(NOT "include;/usr/include;/opt/ros/jade/include " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/opt/ros/jade/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chengque/catkin_ws/pixhawk/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chengque/catkin_ws/pixhawk/lib;/mnt/project/documents/uav/workspace/ros/catkin_ws/devel/lib;/opt/ros/jade/lib)
