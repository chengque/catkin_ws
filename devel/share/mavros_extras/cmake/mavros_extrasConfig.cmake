...
if("TRUE" STREQUAL "TRUE")
  set(mavros_extras_SOURCE_PREFIX /home/chengque/catkin_ws/src/mavros_pkg/mavros_extras)
  set(mavros_extras_DEVEL_PREFIX /home/chengque/catkin_ws/devel)
  ...
  set(mavros_extras_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/home/chengque/catkin_ws/devel/include;/opt/ros/jade/include " STREQUAL " ")
  set(mavros_extras_INCLUDE_DIRS "")
  set(_include_dirs "/home/chengque/catkin_ws/devel/include;/opt/ros/jade/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mavros_extras' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mavros_extras' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chengque/catkin_ws/src/mavros_pkg/mavros_extras/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
    _list_append_unique(mavros_extras_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavros_extras")
...
set(mavros_extras_EXPORTED_TARGETS "mavros_extras_generate_messages_cpp;mavros_extras_generate_messages_eus;mavros_extras_generate_messages_lisp;mavros_extras_generate_messages_py")
...
set(depends "image_transport;mavros;roscpp;sensor_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mavros_extras_dep}_FOUND)
      find_package(${mavros_extras_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mavros_extras_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "mavros_extras-msg-extras.cmake")
