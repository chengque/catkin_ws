...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/chengque/catkin_ws/src/mavros_pkg/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/chengque/catkin_ws/devel_isolated/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/home/chengque/catkin_ws/src/mavros_pkg/libmavconn/include;/usr/include;/opt/ros/jade/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/chengque/catkin_ws/src/mavros_pkg/libmavconn/include;/usr/include;/opt/ros/jade/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chengque/catkin_ws/src/mavros_pkg/libmavconn/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/i386-linux-gnu/libboost_system.so;/usr/lib/i386-linux-gnu/libconsole_bridge.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chengque/catkin_ws/devel_isolated/libmavconn/lib;/mnt/project/documents/uav/workspace/ros/catkin_ws/devel/lib;/opt/ros/jade/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${libmavconn_dep}_FOUND)
      find_package(${libmavconn_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${libmavconn_dep} REQUIRED ${depend_list})
  endif()
